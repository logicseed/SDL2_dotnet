...
namespace SDL.Events
{
    ...
    public struct TextInputEventArgs : IEquatable<TextInputEventArgs>
    {
        /// <summary>
...
#pragma warning restore IDE0011 // Add braces
        ...
        {
            return obj is TextInputEventArgs args && Equals(args);
        }

        public bool Equals(TextInputEventArgs other)
        {
            return
                _type == other._type &&
        ...
        public static bool operator ==(TextInputEventArgs left, TextInputEventArgs right)
        {
